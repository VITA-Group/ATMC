...
import util_trts
from utee.util import quant_model_params
...
if args.abc_special:
    ...
    if not args.lr_initialize:
        ...
        with open(os.path.join(args.loaddir, args.model_name[:-4] + ".npy"), "rb") as filestream:
...
model = quant_model_params(model=model, quant_method=args.quant_method, param_bits=args.param_bits, bn_bits=args.bn_bits, overflow_rate=args.overflow_rate)
