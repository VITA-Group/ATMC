...
if args.abc_special:
    ...
    if not args.lr_initialize:
        ...
        pk_descripter = "{}_proj_{}_nnz_{}_quant_{}_bits_{}_".format(defend_name, prune_name, args.prune_ratio, None, 32)
        fname = os.path.join(args.loaddir, args.prefix_name + pk_descripter + args.save_model_name[0:-4] + ".npy")
