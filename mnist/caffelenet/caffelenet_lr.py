...
class CaffeLeNet(caffelenet_super.CaffeLeNetSuper, super_class.DeepLRModel):
    def __init__(self, ranks):
        super(CaffeLeNet, self).__init__(ConvF=super_class.Conv2dlr, LinF=super_class.Linearlr, ranks=ranks)
