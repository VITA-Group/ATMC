...
if args.raw_train:
    ...
    model_path = os.path.join(args.logdir, "quant_latest_" + descripter + args.model_name)
...
try:
    ...
    #         quantize_tk=quantize_lambda, rho=0.1, admm_interval=args.quant_interval, proj_interval=args.prune_interval)
    ...
    #                 modelz.module.replace_bias(model, weight_name)
    #             else:
